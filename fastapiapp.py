...
class TripRequest(BaseModel):
    origin: str = Field(..., example="San Mateo, CA",description="Your current location")
    destination: str = Field(..., example="Bali, Indonesia",description="Destination city and country")
    start_date: date = Field(..., example="2024-03-01",description="Start date of your trip")
    end_date: date = Field(..., example="2024-03-10",description="End date of your trip")
