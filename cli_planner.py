...
if __name__ == "__main__":
    main()
    # python cli_planner.py -o "mumbai" -d "Crabi, Thailand" -s "2025-04-05" -e "2025-04-15" -i "2 adults who love swimming, dancing, and romance"